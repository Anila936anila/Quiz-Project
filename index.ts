...
const quiz: {
    ...
    },
    {
        name: "question_2",
        type: "list",
        message: "Q2. Which of the following cheracters is commonly allowed in variable names in Typescript?",
        choices: ["$", "@", "#", "&"]
    },
    {
        name: "question_3",
    ...
    },
    {
        name: "question_4",
        type: "list",
        message: "Q4. In Typescript, which symbol is commonly used in terminate a statement?",
        choices: [".", ",", ";", ":"]    
    },
    {
        name: "question_5",
